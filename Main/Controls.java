...
public class Controls {
	public static char high, low, up, down, left, right, menu, jump,
			statusChange, inventory, fly, fullScreen, polygonMode;
	public static boolean isHighPressed, isLowPressed, isUpPressed,
			isDownPressed, isLeftPressed, isRightPressed, isMenuPressed,
			isJumpPressed, isStatusChangePressed, isInventoryPressed,
			isLeftClicked, isRightClicked, isFlyPressed, isFullScreenPressed,
			isPolygonModePressed;
	public static boolean isHighPressedLastFrame, isLowPressedLastFrame,
			isUpPressedLastFrame, isDownPressedLastFrame,
